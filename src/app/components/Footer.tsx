        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-between items-start">
            <div className="w-full md:w-1/3 mb-6 md:mb-0">
              <Link href="/">
                <motion.h2 
                  className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-purple-600 font-orbitron"
                  whileHover={{ scale: 1.05 }}
                >
                  CryptoQuest
                </motion.h2>
              </Link>
              <p className="mt-2 text-sm text-gray-300">Embark on your blockchain adventure</p>
            </div>
            <div className="w-full md:w-1/3 mb-6 md:mb-0">
              ...
              <nav>
                <ul className="space-y-2">
                  ...
                  <motion.li whileHover={{ x: 5 }}>
                    <Link href="/auth" className="hover:text-pink-400 transition-colors">
                      Sign In / Sign Up
                    </Link>
                  </motion.li>
                  <motion.li whileHover={{ x: 5 }}>
            ...
            <div className="w-full md:w-1/3">
              ...
              <div className="flex space-x-4">
                ...
                <motion.a 
                  href="https://www.instagram.com/_justabitofani_" 
                  target="_blank" 
